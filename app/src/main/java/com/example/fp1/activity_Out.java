...
public class activity_Out extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbrw = new Myexpend(this).getWritableDatabase();
        ...
        btn_determine.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if (ed_money.length() < 1  || ed_year.length() < 1 || ed_month.length() < 1 || ed_day.length() < 1)
                    Toast.makeText(activity_Out.this, "欄位請勿空白", Toast.LENGTH_SHORT).show();
                else {
                    try {
                        ...
                        Toast.makeText(activity_Out.this, "已新增金額" + ed_money.getText().toString() + " 原因" + ed_reason.getText().toString()+
                        ...
                        Toast.makeText(activity_Out.this, "新增失敗:" + e.toString(), Toast.LENGTH_LONG).show();
                    }
                }
            }
        });
